...
lm2 <- lm(logGDP ~ labour_force_participation_rate_female_percent + labour_force_participation_rate_male_percent + mean_age_at_marriage_female + mean_age_at_marriage_male + contraceptive_prevalence_rate_any_method_percent + womens_share_of_tertiary_enrolment_percent  + womens_share_of_labour_force_percent + total_fertility_rate_per_woman + percent_women_in_parliament , data = gender_info2)

lm3 <- lm(logGDP ~ labour_force_participation_rate_female_percent + labour_force_participation_rate_male_percent + mean_age_at_marriage_male + contraceptive_prevalence_rate_any_method_percent + womens_share_of_tertiary_enrolment_percent  + womens_share_of_labour_force_percent + total_fertility_rate_per_woman + percent_women_in_parliament , data = gender_info2)

lm4 <- lm(logGDP ~ labour_force_participation_rate_female_percent + labour_force_participation_rate_male_percent + mean_age_at_marriage_male + womens_share_of_tertiary_enrolment_percent  + womens_share_of_labour_force_percent + total_fertility_rate_per_woman + percent_women_in_parliament , data = gender_info2)

lm5 <- lm(logGDP ~ labour_force_participation_rate_female_percent + labour_force_participation_rate_male_percent + mean_age_at_marriage_male + womens_share_of_labour_force_percent + total_fertility_rate_per_woman + percent_women_in_parliament , data = gender_info2)

lm6 <- lm(logGDP ~ labour_force_participation_rate_female_percent + labour_force_participation_rate_male_percent + mean_age_at_marriage_male + womens_share_of_labour_force_percent + total_fertility_rate_per_woman, data = gender_info2)
